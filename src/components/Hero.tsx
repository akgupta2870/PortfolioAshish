...
export default function Hero({ darkMode }: HeroProps) {
  ...
  return (
    ...
    >
      {/* Absolute Full-Screen Interactive WebGL AI Neural Network Background */}
      ...
      {/* Hero Content */}
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-20 w-full pt-6 md:pt-12 lg:pt-0">
        <div className="flex flex-col items-center lg:items-start w-full">
          
          {/* Headline and Content */}
          <div className="lg:max-w-4xl flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <div className="flex flex-col items-center lg:items-start mb-6">
              <motion.div
                ...
                className="text-2xl sm:text-3xl md:text-5xl font-display font-extrabold tracking-tight flex items-center justify-center lg:justify-start gap-2 flex-wrap"
              >
                ...
                <span className="relative inline-block px-3 py-1">
                  ...
                  <motion.span
                    ...
                    className={`absolute inset-y-0 left-0 rounded-xl -z-10 border shadow-lg ${
                      darkMode 
                        ? "bg-gradient-to-r from-indigo-500/20 via-purple-500/15 to-emerald-500/10 border-brand-purple/20 shadow-brand-purple/5" 
                        : "bg-sky-100/75 border-sky-200/50 shadow-sky-500/5"
                    }`}
                  />
                  ...
                  <motion.span
                    ...
                    className={`absolute inset-0 rounded-xl border blur-[2px] pointer-events-none ${
                      darkMode ? "border-indigo-500/30" : "border-sky-300/40"
                    }`}
                  />
                  <span className={`font-black tracking-tight drop-shadow-sm ${
                    darkMode 
                      ? "text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-400 to-emerald-400" 
                      : "text-transparent bg-clip-text bg-gradient-to-r from-sky-600 via-indigo-600 to-sky-700"
                  }`}>
                    Ashish Kumar
                  </span>
                </span>
            ...
            <motion.h2
              ...
              className="font-display font-extrabold text-3xl sm:text-5xl md:text-6xl lg:text-7xl tracking-tight leading-[1.1] mb-6 max-w-4xl"
            >
            ...
            <motion.div
              ...
              className="h-8 md:h-10 flex items-center justify-center lg:justify-start font-display text-lg md:text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-brand-cyan to-brand-purple mb-8"
            >
            ...
            >
              A React & Full-Stack Developer with **{personalInfo.experienceYears} of proven expertise** creating
            ...
            <motion.div
              ...
              className="flex items-center gap-4 mt-12 mb-8 lg:mb-0"
            >
              <a
        ...
        <motion.div
          ...
          className="absolute bottom-[-16px] md:bottom-[-20px] lg:bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 cursor-pointer z-30"
